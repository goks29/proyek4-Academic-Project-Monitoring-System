...
/// Layanan untuk mengelola penyimpanan fase kemajuan proyek di database lokal (Hive).
class PhaseLocalService {
  final Box<ProgressPhaseModel> _box;

  PhaseLocalService(this._box);

  /// Mengambil daftar fase berdasarkan workspace, diurutkan sesuai urutan fase.
  ...
  /// Menyimpan data fase ke storage lokal.
  ...
  /// Menyimpan daftar fase sekaligus ke storage lokal.
